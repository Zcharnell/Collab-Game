...
var progressbar = $.widget( "ui.progressbar", {
	...
	_create: function() {
		...
		this.options.orientation = this._orientation();
		...
		if(this.options.orientation === 'horizontal'){
			this.element.addClass( "ui-progressbar-horizontal ui-widget ui-widget-content ui-corner-all" );
			this.valueDiv = $( "<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>" )
			.appendTo( this.element );
		}
		else if(this.options.orientation === 'vertical'){
			this.element.addClass( "ui-progressbar-vertical ui-widget ui-widget-content ui-corner-all" );
			this.valueDiv = $( "<div class='ui-progressbar-value ui-widget-header ui-corner-bottom'></div>" )
			.appendTo( this.element );
		}
	...
	_orientation: function( newOrientation ) {
	...
	_refreshValue: function() {
		...
		if(orientation === 'horizontal'){
			...
			this.valueDiv.height( percentage.toFixed(0) + "%" )
			.toggleClass( "ui-corner-top", value === this.options.max );
		}
